...
- Which code path attached the 46 leads without copy, by name. The variable
  signature says "not the factory" and says enrichment wrote those fields; it
  does not yet name the script.
- Whether 492/494/495/496/497/498 have the same 46-lead shape or a different
  one. Only 491's leads were profiled individually.
- Whether anything still attaches leads this way TODAY. The empty-render gate
  now blocks the send, but a gate blocking the symptom is not the same as the
  cause being gone.
