...
FILES CHANGED:
  ...
  tests/test_the_send_is_recorded_once_and_by_the_provider.py - a real client domain → fixture.example
...
FINDINGS:
  1. PRIVACY: 6 forbidden names remain in files outside Qwen's allowed scope:
     - docs/CHECKPOINT-2026-09-14-CLAUDE-SESSION.md: another account
     - docs/CLAUDE-HANDOFF.md: another account, one account, a third account
     - docs/CONTEXT-RESET-2026-09-14.md: one account
     - src/providers/heyreach.py: a fourth account (FORBIDDEN file - Claude only)
