...
blocker MOVES as each is fixed. Observed today, in order:
    ...
    pass 2   <client-a86dfd>-com/ranjan-damodar connected_1 vs 2, 3, 4; 2 vs 4; 3 vs 4
...
Pass 1 blocker: `<client-a86dfd>-com/ranjan-damodar`
...
**Model calls per pass:** 18 per record that fails (6 steps × 3 attempts). Pass 1 spent 18 calls on <client-a86dfd>-com alone.

**Records still failing after last pass:** 1 contact on 1 record (`<client-a86dfd>-com/ranjan-damodar`)

**RISKS:**
- The scratch queue at `C:\Users\Zvonimir\Desktop\task061-scratch\queue.jsonl` has 18 failed generation attempts logged in <client-a86dfd>-com's event history but the stored notes are unchanged
