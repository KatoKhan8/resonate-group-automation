...
greetings. They open with content:
    ...
    "<client-593687> describes itself as a unique collection of designers..."
...
Some emails address the recipient by first name in the body:
    ...
    "<contact-98aafc>, I want to respect your time and priorities."
...
**For a contact WITH a name (e.g., first_name = "<contact-98aafc>"):**

The body may address them by name in the content, as em5 does:

> <contact-98aafc>, I want to respect your time and priorities. If improving
> utilisation and capacity planning at <client-593687> is not a priority right
...
> <client-593687> describes itself as a unique collection of designers, producers,
...
- em1 for <contact-6fef2d>-baron: "<client-593687> describes itself as a unique collection
...
**For a contact WITH a name and a company (first_name = "a3f7...", company = "<client-593687>"):**

Subject: Improving delivery visibility at <client-593687>
...
**For a contact WITHOUT a name (first_name = "", company = "<client-593687>"):**
