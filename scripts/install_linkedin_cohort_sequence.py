#!/usr/bin/env python3
"""Reproduce 599020's audited sequence into HeyReach campaign 605487.

    py -3 scripts/install_linkedin_cohort_sequence.py            # dry run
    py -3 scripts/install_linkedin_cohort_sequence.py --live      # write it
