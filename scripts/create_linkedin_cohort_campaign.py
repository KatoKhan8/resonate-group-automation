#!/usr/bin/env python3
"""Create the LinkedIn DRAFT production campaign bound to list 943957.

    py -3 scripts/create_linkedin_cohort_campaign.py            # dry run
    py -3 scripts/create_linkedin_cohort_campaign.py --live      # create it
...
list 943957: unbound, holding exactly the 4 contacts whose accounts pass
