...
"""Create the EmailBison CONTROL campaign and write its sequence. Authorized.
    ...
    py -3 scripts/write_control_campaign.py            # dry run, sends nothing
    py -3 scripts/write_control_campaign.py --live     # perform the write
...
ORDER MATTERS. Run this AFTER the approval:
    ...
    2  py -3 scripts/write_control_campaign.py --live   this file
