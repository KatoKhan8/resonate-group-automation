#!/usr/bin/env python3
"""Canonical Resonate OS campaign row for HeyReach campaign 605732.

    py -3 scripts/create_linkedin_cohort_b_row.py            # dry run
    py -3 scripts/create_linkedin_cohort_b_row.py --live      # write the row
