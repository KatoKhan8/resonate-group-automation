...
def _write_doc(stamp, results, payload_entries, all_lint_pass, all_claims_pass,
    ...
    lines.append("")
    lines.append("**For px-d814b9bcb642 (#1):** li1-li5 have operator-control-arm approval. "
    ...
    lines.append("")
    lines.append("**For px-ecfd847755c1 (#2) and px-b8cf25c80e28 (#3):** All steps are "
    ...
    lines.append("")
    lines.append("**The practical effect:** 2 of 3 canary contacts (px-ecfd847755c1, "
                 "px-b8cf25c80e28) have no operator-approved copy. Their generated "
    ...
    lines.append("")
    lines.append("Only px-d814b9bcb642 has operator-control-arm approval for li1-li5, "
