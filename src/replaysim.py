...
SCENARIOS = {
    ...
    "linkedin_reply": {
        ...
        # TASK-066: "Happy to connect" is a LinkedIn short affirmative and
        # classifies as POSITIVE.  The company is paused and a human is
        # notified - which is the safe direction for a buying signal.
        "expect": replies.POSITIVE,
    },
