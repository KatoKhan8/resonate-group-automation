...
# Complete ISO 3166-1 alpha-2 set, 249 officially assigned codes.
...
# "UK" is an exceptionally reserved alias for GB.
ISO_TO_NAME = {
    ...
    # Exceptionally reserved code for United Kingdom.
    "UK": "United Kingdom",
}
