...
MONITORS = [
    ...
    {"name": "bison_watch_491",
     "module": "scripts.bison_watch_loop",
     "args": ["--campaign", "491", "--interval", "180"], "interval": 180},
    {"name": "bison_watch_492",
     "module": "scripts.bison_watch_loop",
     "args": ["--campaign", "492", "--interval", "180"], "interval": 180},
    {"name": "bison_watch_494",
     "module": "scripts.bison_watch_loop",
     "args": ["--campaign", "494", "--interval", "180"], "interval": 180},
    {"name": "bison_watch_495",
     "module": "scripts.bison_watch_loop",
     "args": ["--campaign", "495", "--interval", "180"], "interval": 180},
    {"name": "bison_watch_496",
     "module": "scripts.bison_watch_loop",
     "args": ["--campaign", "496", "--interval", "180"], "interval": 180},
    {"name": "bison_watch_497",
     "module": "scripts.bison_watch_loop",
     "args": ["--campaign", "497", "--interval", "180"], "interval": 180},
    {"name": "bison_watch_498",
     "module": "scripts.bison_watch_loop",
     "args": ["--campaign", "498", "--interval", "180"], "interval": 180},
    {"name": "heyreach_watch",
